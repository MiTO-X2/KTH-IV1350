...
public class ReceiptDTO {
     ...
     * @param itemDTOList The list of items in the sale, in the form of an itemDTO.
     * @param items The number of items sold.
     * @param totalPrice The total price of the sale.
     * @param totalVAT The total VAT of the sale.
     * @param discountAmount The total amount of discount of the sale.
     * @param totalPriceAfterDiscount The price of the sale after the discount has been applied.
    ...
    public ReceiptDTO(LocalDateTime dateAndTime, List<ItemDTO> itemDTOList, int items, Amount totalPrice, Amount totalVAT, 
                      Amount discountAmount, Amount totalPriceAfterDiscount, Amount amountPaid, Amount change) {
    ...
    /**
     * Gets the total price of the sale after the discount.
     *
