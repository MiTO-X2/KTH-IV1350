...
class CompositeDiscountStrategyTest {
    ...
    @Test
    void testCompositeWithNullStrategyInList_throwsExceptionOrIgnores() {
        DiscountStrategy strategy1 = sale -> new Amount(5.0);
        DiscountStrategy nullStrategy = null;
        CompositeDiscountStrategy composite = new CompositeDiscountStrategy(Arrays.asList(strategy1, nullStrategy));

        assertThrows(NullPointerException.class, () -> composite.calculateDiscount(mockSale));
    }
}